...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Shivanshu Chauhan
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">Passionate CS undergraduate ('25) specializing in competitive programming and full-stack web development, adept at crafting scalable, responsive solutions and solving complex challenges.</p>
